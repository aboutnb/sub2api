		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyCommunityGroupName: "技术交流",
					service.SettingKeyCommunityGroupIcon: "data:image/svg+xml;base64,PHN2Zz4=",
					service.SettingKeyCommunityGroupURL:  "https://example.com/community",
			...
			wantJSON: `{
				...
				"data": {
					...
					"payment_cancel_rate_limit_unit": "",
						...
						"usdt_payment_config_warnings": null,
						"usdt_payment_enabled": false,
						"usdt_payment_enabled_networks": null,
						"usdt_payment_fiat": "",
						"usdt_payment_key_id": "",
						"usdt_payment_late_payment_window_minutes": 0,
						"usdt_payment_minimum_amount": 0,
						"usdt_payment_order_timeout_seconds": 0,
						"usdt_payment_public_base_url": "",
						"usdt_payment_public_callback_base_url": "",
						"usdt_payment_reconcile_batch_size": 0,
						"usdt_payment_reconcile_interval_seconds": 0,
						"usdt_payment_request_timeout_seconds": 0,
						"usdt_payment_webhook_clock_skew_seconds": 0,

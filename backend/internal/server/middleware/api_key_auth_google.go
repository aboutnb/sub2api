...
func APIKeyAuthWithSubscriptionGoogle(apiKeyService *service.APIKeyService, subscriptionService *service.SubscriptionService, cfg *config.Config) gin.HandlerFunc {
	return apiKeyAuthWithSubscriptionGoogle(apiKeyService, subscriptionService, cfg, nil)
}

func APIKeyAuthWithSubscriptionGoogleAndResolver(apiKeyService *service.APIKeyService, subscriptionService *service.SubscriptionService, cfg *config.Config, resolver APIKeyGroupResolver) gin.HandlerFunc {
	return apiKeyAuthWithSubscriptionGoogle(apiKeyService, subscriptionService, cfg, resolver)
}

func apiKeyAuthWithSubscriptionGoogle(apiKeyService *service.APIKeyService, subscriptionService *service.SubscriptionService, cfg *config.Config, resolver APIKeyGroupResolver) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if apiKey.GroupID == nil && resolver != nil {
			resolved, resolveErr := resolver.Resolve(c, apiKey)
			if resolveErr != nil {
				abortWithGoogleError(c, infraerrors.Code(resolveErr), infraerrors.Message(resolveErr))
				return
			}
			if resolved != nil {
				apiKey = resolved
		...
		if !ownerScopedHistory && isSubscriptionType && subscriptionService != nil {

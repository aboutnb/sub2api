...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/user/checkin":                                      "user.checkin.claim",
	"PUT /api/v1/admin/checkin/config":                               "admin.checkin.config.update",
	"POST /api/v1/admin/audit-logs/clear":                            service.AuditActionAuditLogClear,
	"POST /api/v1/admin/auth-ip-bans/:id/release":                    "admin.auth_ip_ban.release",
	"PUT /api/v1/admin/registration-protection/settings":             "admin.registration_protection.settings",
	"POST /api/v1/admin/registration-protection/accounts/:id/review": "admin.registration_protection.review",
	"POST /api/v1/admin/registration-protection/blocks/:id/release":  "admin.registration_protection.release_source",

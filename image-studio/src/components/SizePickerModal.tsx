...
export default function SizePickerModal({ currentSize, onSelect, onClose, allowAuto = true, codexCli = false }: Props) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className="relative z-10 flex max-h-[calc(100dvh-2rem)] w-full max-w-md flex-col overflow-hidden rounded-3xl border border-white/50 bg-white/95 p-4 shadow-2xl ring-1 ring-black/5 animate-modal-in dark:border-white/[0.08] dark:bg-gray-900/95 dark:ring-white/10 sm:p-5"
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 sm:gap-6">
          ...
          <div className="min-h-0 flex-1 touch-pan-y overflow-y-auto overscroll-contain pr-1 pb-2 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-white/10">
            {mode === 'auto' && (
          ...
          <div className="shrink-0 rounded-2xl bg-gray-50 px-4 py-3 dark:bg-white/[0.03]">

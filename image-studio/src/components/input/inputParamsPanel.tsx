...
export default function InputParamsPanel({
  ...
  return (
    <div className={`grid ${cols} gap-2 text-xs flex-1`}>
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("尺寸")}</span>
        <button
          type="button"
          aria-label={studioText('尺寸')}
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("质量")}</span>
        <Select
      ...
      <label className="flex flex-col gap-0.5">
        <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("格式")}</span>
        <Select
      ...
      {showTransparentOutputControl && (
        ...
        >
          <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("透明背景")}</span>
          <Select
      ...
      {!showTransparentOutputControl && (
        ...
        >
          <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("压缩率")}</span>
          <input
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("审核")}</span>
        <Select
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{studioText("数量")}</span>
        <input
          value={nInput}

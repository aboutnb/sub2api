<template>
  <div class="empty-state">
    <!-- Icon -->
    <div
      class="mb-5 flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-line-strong bg-primary-50 shadow-pixel-sm dark:border-line-strong dark:bg-primary-900/20"
    >
      <slot name="icon">

<template>
  <div v-if="subscriptionFeatureEnabled" class="relative shrink-0" ref="containerRef" @focusout="handleFocusout">
...
const subscriptionFeatureEnabled = computed(() =>
  isFeatureFlagEnabled(FeatureFlags.subscription) && isFeatureFlagEnabled(FeatureFlags.userSubscriptions)
)

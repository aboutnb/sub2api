  ...
  >
    ...
    <Teleport to="body">
      ...
      <div
        ...
        role="tooltip"
        :class="[
          'fixed z-[99999] -translate-x-1/2 -translate-y-full rounded-xl border-2 border-ink-strong bg-gray-900 p-3 text-xs leading-relaxed text-white shadow-xl ring-1 ring-white/10 selection:bg-primary-200 selection:text-ink-strong before:absolute before:inset-x-0 before:top-full before:h-3 dark:border-line-strong dark:bg-surface dark:selection:bg-primary-200 dark:selection:text-ink-strong',
          props.widthClass,
        ]"

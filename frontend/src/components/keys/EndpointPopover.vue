...
<template>
  <div v-if="allEndpoints.length > 0" class="flex flex-wrap gap-2">
    <div
      ...
      :key="index"
      class="flex items-center gap-1.5 rounded-lg border border-line bg-white px-2.5 py-1.5 text-xs transition-colors hover:border-primary-200 dark:border-line-strong dark:bg-surface dark:hover:border-primary-700"
    >
      ...
      <div class="group/endpoint relative flex items-center gap-1.5">
        ...
        <code
          class="cursor-pointer font-mono text-ink-muted decoration-gray-400 decoration-dashed underline-offset-2 hover:text-primary-600 hover:underline focus:text-primary-600 focus:underline focus:outline-none dark:text-ink-muted dark:decoration-gray-500 dark:hover:text-primary-400 dark:focus:text-primary-400"
          role="button"
          tabindex="0"
        ...
        <button
          ...
          :class="copiedEndpoint === item.endpoint
            ...
            : 'text-ink-muted hover:text-primary-500 dark:text-ink-muted dark:hover:text-primary-400'"
        ...
        <a
          ...
          class="rounded p-0.5 text-ink-muted transition-colors hover:text-amber-500 dark:text-ink-muted dark:hover:text-amber-400"

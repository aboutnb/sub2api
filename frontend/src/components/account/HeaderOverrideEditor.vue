<template>
  ...
  <button
    type="button"
    class="w-full rounded-lg border-2 border-dashed border-line-strong px-4 py-2 text-ink transition-colors hover:border-line-strong hover:text-ink dark:border-line-strong dark:text-ink-muted dark:hover:border-line-strong dark:hover:text-ink-muted"
    @click="addRow"
  >

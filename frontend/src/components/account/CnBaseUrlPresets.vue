    ...
    <button
      ...
      :class="[
        ...
        isActive(preset)
          ...
          : 'bg-surface-muted text-ink hover:bg-primary-50 hover:text-primary-700 dark:bg-line-strong dark:text-ink-muted dark:hover:bg-primary-900/30 dark:hover:text-primary-400'
      ]"

  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-primary-500 text-white' : 'bg-line text-ink-muted dark:bg-line-strong'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-ink dark:text-ink-muted">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-line-strong dark:bg-line-strong" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-primary-500 text-white' : 'bg-line text-ink-muted dark:bg-line-strong'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-lg bg-surface-muted p-1 dark:bg-surface-muted" data-tour="account-form-platform">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ? 'bg-white text-orange-600 shadow-sm dark:bg-line-strong dark:text-orange-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-white text-green-600 shadow-sm dark:bg-line-strong dark:text-green-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'gemini'
                ? 'bg-white text-blue-600 shadow-sm dark:bg-line-strong dark:text-blue-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'antigravity'
                ? 'bg-white text-purple-600 shadow-sm dark:bg-line-strong dark:text-purple-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
          ...
          <button
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all',
              form.platform === 'grok'
                ? 'bg-white text-zinc-900 shadow-sm dark:bg-line-strong dark:text-zinc-100'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
        ...
        <div class="mt-2 flex flex-wrap rounded-lg bg-surface-muted p-1 dark:bg-surface-muted">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'kimi'
                ? 'bg-white text-pink-600 shadow-sm dark:bg-line-strong dark:text-pink-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
          ...
          <button
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-3 py-2.5 text-sm font-medium transition-all',
              form.platform === 'zhipu'
                ? 'bg-white text-indigo-600 shadow-sm dark:bg-line-strong dark:text-indigo-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'deepseek'
                ? 'bg-white text-teal-600 shadow-sm dark:bg-line-strong dark:text-teal-400'
                : 'text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-orange-300 dark:border-line-strong dark:hover:border-orange-700'
            ]"
          >
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ...
                  : 'bg-surface-muted text-ink-muted dark:bg-line-strong dark:text-ink-muted'
              ]"
            >
              <Icon name="sparkles" size="sm" />
            </div>
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">{{
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ...
                : 'border-line hover:border-purple-300 dark:border-line-strong dark:hover:border-purple-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ...
                : 'border-line hover:border-amber-300 dark:border-line-strong dark:hover:border-amber-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ...
                : 'border-line hover:border-sky-300 dark:border-line-strong dark:hover:border-sky-700'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">Vertex</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">Service Account</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'openai'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-green-300 dark:border-line-strong dark:hover:border-green-700'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">OAuth</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">API Key</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-zinc-400 dark:border-line-strong dark:hover:border-zinc-600'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">OAuth</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.types.grokOauth') }}</span>
            </div>
          </button>
        ...
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2" data-tour="account-form-mode">
          ...
          <button
            ...
            :class="[
              ...
              accountMode === 'payg'
                ? cnAccentActiveClass
                : 'border-line hover:border-line-strong dark:border-line-strong dark:hover:border-gray-600'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">{{ t('admin.accounts.cnProviders.accountMode.payg') }}</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.cnProviders.accountMode.paygDesc') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">{{ t('admin.accounts.cnProviders.accountMode.coding') }}</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.cnProviders.accountMode.codingDesc') }}</span>
            </div>
          </button>
        </div>
      </div>
      ...
      <div v-if="isMultiProtocolPlatform" class="mt-4">
        ...
        <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">{{ t(`admin.accounts.cnProviders.apiProtocol.${opt.labelKey}`) }}</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t(`admin.accounts.cnProviders.apiProtocol.${opt.labelKey}Desc`) }}</span>
            </div>
          </button>
        </div>
      </div>
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-blue-300 dark:border-line-strong dark:hover:border-blue-700'
            ]"
          >
            <div
              :class="[
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 text-sm text-ink hover:text-ink-strong dark:text-ink-muted dark:hover:text-gray-200"
            >
              <svg
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">OAuth</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink-strong dark:text-white">API Key</span>
              <span class="text-xs text-ink-muted dark:text-ink-muted">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
      ...
      <div v-if="form.platform === 'antigravity' && antigravityAccountType === 'upstream'" class="space-y-4">
        ...
        <div class="flex items-center justify-between gap-4 border-t border-line pt-4 dark:border-line-strong">
          <div>
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ...
                : 'border-line-strong bg-surface-muted hover:border-sky-400 hover:bg-sky-50/60 dark:border-line-strong dark:bg-surface-muted/40 dark:hover:border-sky-600 dark:hover:bg-sky-900/10'
            ]"
          ...
          >
            ...
            <div
              ...
              class="mt-3 rounded-md border border-sky-200 bg-white px-3 py-2 text-xs text-sky-900 dark:border-sky-800/50 dark:bg-surface dark:text-sky-200"
            >
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-line pt-4 dark:border-line-strong">
          ...
          <div v-if="antigravityModelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                />
                <svg class="h-4 w-4 flex-shrink-0 text-ink-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div v-if="form.platform === 'anthropic' && isOAuthFlow">
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            ...
            />
            <span class="text-sm text-ink dark:text-ink-muted">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div
          class="flex items-center justify-between gap-4 border-t border-line pt-4 dark:border-line-strong"
        >
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.upstreamBilling.autoProbe') }}</label>
            <p class="mt-1 text-xs text-ink-muted dark:text-ink-muted">
          ...
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
        ...
        <div class="border-t border-line pt-4 dark:border-line-strong">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
      ...
      <div v-if="form.platform === 'anthropic' && accountCategory === 'bedrock'" class="space-y-4">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-primary-600 focus:ring-primary-500"
              />
              <span class="text-sm text-ink dark:text-ink-muted">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-primary-600 focus:ring-primary-500"
              />
              <span class="text-sm text-ink dark:text-ink-muted">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span class="text-sm text-ink dark:text-ink-muted">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
      ...
      <div
        ...
        class="border-t border-line pt-4 dark:border-line-strong space-y-4"
      >
        <div class="mb-3">
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              grokOAuthCustomBaseUrlEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
            ]"
          >
            <span
              :class="[
      ...
      <div class="border-t border-line pt-4 dark:border-line-strong space-y-4">
        <div class="mb-3 flex items-center justify-between">
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-surface-muted px-3 py-1.5 text-xs font-medium text-ink transition-colors hover:bg-line dark:bg-line-strong dark:text-ink-muted dark:hover:bg-dark-500"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <div v-if="tempUnschedRules.length > 0" class="space-y-3">
            ...
            >
              <div class="mb-2 flex items-center justify-between">
                <span class="text-xs font-medium text-ink-muted dark:text-ink-muted">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-ink-muted transition-colors hover:text-ink disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-gray-200"
                  >
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-line-strong px-4 py-2 text-sm text-ink transition-colors hover:border-line-strong hover:text-ink dark:border-line-strong dark:text-ink-muted dark:hover:border-line-strong dark:hover:text-ink-muted"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        ...
        <!-- Window Cost Limit -->
        <div class="rounded-lg border border-line p-4 dark:border-line-strong">
          <div class="mb-3 flex items-center justify-between">
            <div>
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                windowCostEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="windowCostEnabled" class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted dark:text-ink-muted">$</span>
                <input
        ...
        <div class="rounded-lg border border-line p-4 dark:border-line-strong">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted dark:text-ink-muted">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-line p-4 dark:border-line-strong">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-line p-4 dark:border-line-strong">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-line p-4 dark:border-line-strong">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-line-strong bg-white px-3 py-2 text-sm shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-line-strong dark:bg-surface-muted dark:text-white"
            >
        ...
        <div class="rounded-lg border border-line p-4 dark:border-line-strong">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
              ]"
            >
              <span
                :class="[
            ...
            <button
              ...
              :class="[
                ...
                proxyMode === 'direct'
                  ...
                  : 'border-line hover:border-primary-300 dark:border-line-strong dark:hover:border-primary-700'
              ]"
            >
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            ...
            <p v-if="openAIWSModeHintKey" class="mt-1 text-xs text-ink-muted">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <div
          ...
          class="mt-4 flex items-center justify-between border-l-2 border-line pl-4 dark:border-line-strong"
        >
          <div>
      ...
      <div
        ...
        class="space-y-4 border-t border-line pt-4 dark:border-line-strong"
      >
        <div class="flex items-center justify-between gap-4">
          <div>
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              ...
              class="h-4 w-4 rounded border-line-strong text-primary-500 focus:ring-primary-500 dark:border-line-strong"
            />
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-line text-xs text-ink-muted hover:bg-line-strong dark:bg-line-strong dark:text-ink-muted dark:hover:bg-dark-500"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded bg-gray-900 px-3 py-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 dark:bg-surface-muted"
            >
    ...
    <div v-else class="space-y-5">
      <OAuthAuthorizationFlow
        ...
        :show-proxy-warning="form.platform !== 'openai' && form.platform !== 'grok' && !!currentDirectProxyId"
  ...
  >
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-ink dark:text-ink-muted">
              {{ t('admin.accounts.gemini.setupGuide.checklistTitle') }}
            </p>
            <ul class="list-inside list-disc space-y-1 text-sm text-ink dark:text-ink-muted">
      ...
      <div class="border-t border-line pt-6 dark:border-line-strong">
        <h3 class="mb-3 text-sm font-semibold text-ink-strong dark:text-white">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-surface-muted dark:bg-line-strong">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-ink dark:text-ink-muted">
            ...
            <tbody class="divide-y divide-line dark:divide-line-strong">
              <tr>
                <td class="px-3 py-2 text-ink-strong dark:text-white">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.channel') }}
                </td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">Free</td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.limitsFree') }}
                </td>
              </tr>
              <tr>
                <td class="px-3 py-2 text-ink-strong dark:text-white"></td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">Pro</td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">
              ...
              <tr>
                <td class="px-3 py-2 text-ink-strong dark:text-white"></td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">Ultra</td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-ink dark:text-ink-muted">Standard</td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">
              ...
              <tr>
                <td class="px-3 py-2 text-ink-strong dark:text-white"></td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">Enterprise</td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">
              ...
              <tr>
                <td class="px-3 py-2 text-ink-strong dark:text-white"></td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">Paid</td>
                <td class="px-3 py-2 text-ink dark:text-ink-muted">
...
const submitCreateAccount = async (payload: CreateAccountRequest) => {
  ...
  try {
    const account = await adminAPI.accounts.create(
      withAntigravityConfirmFlag(withCurrentProxySelection(payload))
    )
  ...
  if (form.platform === 'openai') {
    ...
    await geminiOAuth.generateAuthUrl(
      ...
      geminiSelectedTier.value
	    ...
	    await grokOAuth.generateAuthUrl(currentDirectProxyId.value)
  } else {

...
<template>
  <div class="rounded-lg border border-line dark:border-line-strong">
      ...
      <div class="flex items-center justify-between p-4" :class="{ 'pb-0': localEnabled && !collapsed }">
        <div class="flex items-center gap-2 flex-1 cursor-pointer" @click="localEnabled && (collapsed = !collapsed)">
          <svg v-if="localEnabled" class="h-4 w-4 text-ink-muted transition-transform" :class="{ '-rotate-90': collapsed }" viewBox="0 0 20 20" fill="currentColor">
        ...
        <button
          ...
          :class="[
            ...
            localEnabled ? 'bg-primary-600' : 'bg-line dark:bg-line-strong'
          ]"
        >
          <span
            :class="[

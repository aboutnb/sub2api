<template>
  <div class="flex flex-wrap gap-2">
    <button
      ...
      class="rounded-lg bg-surface-muted px-3 py-1 text-xs text-ink transition-colors hover:bg-primary-50 hover:text-primary-700 dark:bg-line-strong dark:text-ink-muted dark:hover:bg-primary-900/30 dark:hover:text-primary-400"

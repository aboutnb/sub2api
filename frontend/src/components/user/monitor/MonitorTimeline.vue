<template>
  <div class="mt-4 pt-3 border-t border-line dark:border-line/60">
    <div
      class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-ink-muted mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-line-strong dark:border-line-strong text-[10px] uppercase tracking-widest text-ink-muted"
    >
    ...
    <div
      class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-ink-muted"
    >
...
const STATUS_COLOR: Record<string, string> = {
  ...
  failed: 'bg-red-500',
  error: 'bg-red-500',
  empty: 'bg-line-strong dark:bg-line-strong',
}

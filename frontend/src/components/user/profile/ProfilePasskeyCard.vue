<template>
  <div class="card">
    <div class="flex items-start justify-between border-b border-line px-6 py-4 dark:border-line">
      <div>
    ...
    <div class="px-6 py-6">
      <div v-if="!enabled" class="mb-5 text-sm text-ink-muted dark:text-ink-muted">
      ...
      <div>
        <form
          v-if="enabled && supported && showAddForm"
          class="mb-5 flex flex-col gap-3 rounded-lg border border-line p-4 dark:border-line"
        ...
        <div
          ...
          class="rounded-lg border border-dashed border-line px-4 py-8 text-center text-sm text-ink-muted dark:border-line dark:text-ink-muted"
        >
          ...
          >
            <div class="min-w-0">
              <div class="flex items-center gap-2">
                ...
                <p class="truncate font-medium text-ink-strong dark:text-white">
                  {{ credential.name }}
                </p>
                <span
    ...
    <div v-if="deleteTarget" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div
          class="relative w-full max-w-md transform rounded-xl bg-white p-6 shadow-xl transition-all dark:bg-surface"
        >

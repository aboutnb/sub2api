<template>
  <div class="card p-4">
    ...
    <div
      ...
      class="flex h-32 items-center justify-center text-sm text-ink-muted dark:text-ink-muted"
    >
    ...
    <div v-else class="space-y-2">
      <div v-for="[currency, currencyUsers] in sortedUsers(props.users)" :key="currency" class="space-y-2">
        ...
        <div
          ...
          :key="user.user_id"
          class="flex items-center justify-between rounded-lg px-3 py-2 hover:bg-surface-muted dark:hover:bg-dark-700"
        >

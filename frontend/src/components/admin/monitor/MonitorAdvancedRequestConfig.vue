  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        >
          ...
          <button
            type="button"
            class="flex-none rounded p-1 text-ink-muted hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-500/10 dark:hover:text-red-400"
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-line-strong px-2 py-1 text-xs text-ink-muted hover:border-primary-400 hover:text-primary-600 dark:border-line-strong dark:text-ink-muted dark:hover:border-primary-500 dark:hover:text-primary-400"
          @click="addRow"
        >
    ...
    <div v-if="bodyOverrideMode !== 'off'">
      <div class="mb-1 flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-xs text-primary-600 hover:underline disabled:cursor-not-allowed disabled:text-ink-muted disabled:no-underline dark:text-primary-400"
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  return 'border-line bg-white text-ink hover:border-primary-300 dark:border-line dark:bg-surface dark:text-ink-muted'
}

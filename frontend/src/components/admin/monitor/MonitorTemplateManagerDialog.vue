<template>
  ...
  >
    <!-- provider tabs -->
    <div class="mb-4 border-b border-line dark:border-line">
      <div role="tablist" class="flex flex-wrap gap-1">
        ...
        >
          ...
          <span
            ...
            class="ml-1.5 rounded-full bg-surface-muted px-2 py-0.5 text-xs dark:bg-surface-muted"
          >
    ...
    <div v-if="!editing" class="space-y-2">
      ...
      <div
        ...
        v-else
        :key="tpl.id"
        class="rounded-lg border border-line bg-white p-4 dark:border-line dark:bg-surface"
      >
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-2">
              <span class="font-medium text-ink-strong dark:text-white">{{ tpl.name }}</span>
              <span
            ...
            <p v-if="tpl.description" class="mt-0.5 text-xs text-ink-muted dark:text-ink-muted">
              {{ tpl.description }}
            </p>
...
function tabClass(value: Provider): string {
  return activeProvider.value === value
    ...
    : 'border-b-2 border-transparent text-ink-muted hover:text-ink dark:text-ink-muted dark:hover:text-gray-200'
}

  ...
  <AppLayout>
        ...
        >
          ...
          <template #cell-code="{ value }">
            <div class="flex items-center space-x-2">
              <code class="font-mono text-sm text-ink-strong dark:text-gray-100">{{ value }}</code>
              <button
          ...
          <template #cell-value="{ value, row }">
            <span class="text-sm font-medium text-ink-strong dark:text-white">
              ...
              <template v-else-if="row.type === 'subscription'">
                ...
                <span v-if="row.group" class="ml-1 text-xs text-ink-muted dark:text-ink-muted"
                  >({{ row.group.name }})</span
                >
              </template>
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
          class="relative z-10 w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-surface"
        >
          <h2 class="mb-4 text-lg font-semibold text-ink-strong dark:text-white">
                ...
                <button
                  ...
                  :class="[
                    ...
                    generateForm.expiry_option === option.value
                      ...
                      : 'border-line text-ink hover:bg-surface-muted dark:border-line-strong dark:text-ink-muted dark:hover:bg-dark-700'
                  ]"
                >
                  {{ option.label }}
                </button>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          class="relative z-10 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl dark:bg-surface"
        >
          <h2 class="mb-1 text-lg font-semibold text-ink-strong dark:text-white">
            {{ t('admin.redeem.batchUpdateTitle') }}
          </h2>
          <p class="mb-4 text-sm text-ink-muted dark:text-ink-muted">
            {{ t('admin.redeem.selectedCount', { count: selectedCount }) }}
          </p>

          <form data-test="batch-update-form" class="space-y-4" @submit.prevent="handleBatchUpdate">
            <div class="space-y-2">
              <label class="flex items-center gap-2 text-sm font-medium text-ink dark:text-ink-muted">
                <input
    ...
    <Teleport to="body">
      <div v-if="showResultDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-white shadow-xl dark:bg-surface">
          <!-- Header -->
          <div
            class="flex items-center justify-between border-b border-line px-5 py-4 dark:border-line-strong"
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                <h2 class="text-base font-semibold text-ink-strong dark:text-white">
            ...
            <button
              ...
              class="rounded-lg p-1.5 text-ink-muted transition-colors hover:bg-surface-muted hover:text-ink dark:hover:bg-dark-700 dark:hover:text-ink-muted"
            >
          ...
          <div class="p-5">
            <div class="relative">
              <textarea
                ...
                class="w-full resize-none rounded-lg border border-line bg-surface-muted p-3 font-mono text-sm text-ink-strong focus:outline-none dark:border-line-strong dark:bg-surface-muted dark:text-gray-200"
              ></textarea>
            </div>
          </div>
          <!-- Footer -->
          <div
            class="flex justify-end gap-2 rounded-b-xl border-t border-line bg-surface-muted px-5 py-4 dark:border-line-strong dark:bg-surface-muted/50"
          >
            <button

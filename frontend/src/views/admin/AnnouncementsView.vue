          ...
          <template #cell-title="{ value, row }">
            <div class="min-w-0">
              <div class="flex items-center gap-2">
                <span class="truncate font-medium text-ink-strong dark:text-white">{{ value }}</span>
              </div>
              <div class="mt-1 flex items-center gap-2 text-xs text-ink-muted dark:text-ink-muted">
                <span>#{{ row.id }}</span>
                <span class="text-ink-muted dark:text-dark-700">·</span>

<template>
  <div class="card">
    <div
      class="flex flex-col gap-3 border-b border-line px-6 py-4 dark:border-line lg:flex-row lg:items-start lg:justify-between"
    >
      <div>
    ...
    <div class="space-y-6 p-6">
      <div
        v-if="loadingList"
        class="flex items-center gap-2 text-sm text-ink-muted dark:text-ink-muted"
      >
        <span
      ...
      <template v-else>
        ...
        >
          <div class="flex flex-wrap items-center gap-2">
            <div class="text-sm font-semibold text-ink-strong dark:text-white">
              {{ selectedEventMeta.label }}
            </div>
            <span
              class="rounded-full bg-white px-2.5 py-1 text-xs font-medium text-ink shadow-sm ring-1 ring-line dark:bg-surface dark:text-ink-muted dark:ring-line-strong"
            >
          ...
          <p class="mt-2 text-sm leading-6 text-ink dark:text-ink-muted">
            {{ selectedEventMeta.timing }}
          </p>
          <p
            v-if="selectedEventDescription"
            class="mt-1 text-xs text-ink-muted dark:text-ink-muted"
          >
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-line bg-white px-3 py-1 font-mono text-xs text-ink transition-colors hover:border-primary-300 hover:text-primary-600 dark:border-line-strong dark:bg-surface-muted dark:text-gray-200 dark:hover:border-primary-500 dark:hover:text-primary-300"
          ...
          <div class="space-y-4">
            <div
              class="rounded-lg border border-line bg-white dark:border-line dark:bg-surface"
            >
              <div
              ...
              <div class="bg-surface-muted p-3 dark:bg-canvas">
                <iframe
                  class="h-[36rem] w-full rounded-md border border-line bg-white dark:border-line"
                  sandbox=""
                  :srcdoc="previewHtml"

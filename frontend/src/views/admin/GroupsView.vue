      ...
      >
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            >
              <p v-if="createModelAllowlistLoading" class="text-xs text-ink-muted dark:text-ink-muted">
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            <div
              class="max-h-64 space-y-2 overflow-y-auto p-2"
            >
              <p v-if="editModelAllowlistLoading" class="text-xs text-ink-muted dark:text-ink-muted">
                {{ t("admin.groups.modelAllowlist.loading") }}
              </p>
              <p

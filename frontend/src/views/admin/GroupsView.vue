          ...
          >
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-lg border border-line bg-white py-1 shadow-lg dark:border-line-strong dark:bg-surface"
              >
                <button
                  v-for="col in toggleableColumns"
                  :key="col.key"
                  @click="toggleColumn(col.key)"
                  class="flex w-full items-center justify-between px-4 py-2 text-left text-sm text-ink hover:bg-surface-muted dark:text-ink-muted dark:hover:bg-dark-700"
                >
                  <span>{{ col.label }}</span>
                  <Icon
      ...
      <template #table>
        ...
        >
          <template #cell-name="{ value }">
            <span class="font-medium text-ink-strong dark:text-white">{{
              value
            }}</span>
          </template>

          <template #cell-id="{ value }">
            <span class="font-mono text-xs text-ink-muted dark:text-ink-muted"
              >#{{ value }}</span
            >
          </template>
          ...
          <template #cell-billing_type="{ row }">
            <div class="space-y-1">
              ...
              <span
                :class="[
                  ...
                  row.subscription_type === 'subscription'
                    ...
                    : 'bg-surface-muted text-ink dark:bg-surface-muted dark:text-ink-muted',
                ]"
              >
                {{
                  row.subscription_type === "subscription"
              ...
              <div
                ...
                class="space-y-0.5 text-xs text-ink-muted dark:text-ink-muted"
              >
                <div
                  v-if="
                    row.daily_limit_usd ||
                ...
                >
                  <span v-if="row.daily_limit_usd" class="whitespace-nowrap">
                    <span
                      v-if="usageLoading"
                      class="font-medium text-ink-muted dark:text-ink-muted"
                      >—</span
                    >
                    <span
                      v-else
                  ...
                  <span
                    ...
                    "
                    class="mx-1 text-ink-muted dark:text-ink"
                    >·</span
                  >
                ...
                <span v-else class="text-ink-muted dark:text-ink-muted">{{
                  t("admin.groups.subscription.noLimit")
                }}</span>
                <div class="text-ink-muted dark:text-ink-muted">
                  {{ t("admin.groups.usageTotal") }}
                  <span class="ml-1 font-medium text-ink dark:text-ink-muted"
                    >{{
                      usageLoading
                        ? "—"
          ...
          <template #cell-account_count="{ row }">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-surface-muted px-1.5 py-0.5 font-medium text-ink-strong dark:bg-line-strong dark:text-ink-muted"
              ...
              <div>
                ...
                <span
                  class="ml-1 font-medium text-ink dark:text-ink-muted"
          ...
          <template #cell-usage="{ row }">
            <div v-if="usageLoading" class="text-xs text-ink-muted">—</div>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-muted transition-colors hover:bg-surface-muted hover:text-primary-600 disabled:cursor-not-allowed disabled:opacity-50 dark:hover:bg-dark-700 dark:hover:text-primary-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-muted transition-colors hover:bg-surface-muted hover:text-cyan-600 dark:hover:bg-dark-700 dark:hover:text-cyan-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-muted transition-colors hover:bg-surface-muted hover:text-purple-600 dark:hover:bg-dark-700 dark:hover:text-purple-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-muted transition-colors hover:bg-surface-muted hover:text-orange-600 dark:hover:bg-dark-700 dark:hover:text-orange-400"
              >
      ...
      >
          ...
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-ink-muted transition-colors hover:text-primary-500 dark:text-ink-muted dark:hover:text-primary-400"
              />
              <div
              ...
              >
                <div
                  class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-surface"
                >
                  <p class="text-xs leading-relaxed text-ink-muted">
                    {{ t("admin.groups.copyAccounts.tooltip") }}
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-surface"
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  ...
                  <p class="mb-2 text-xs leading-relaxed text-ink-muted">
                    {{ t("admin.groups.exclusiveTooltip.description") }}
                  </p>
                  <div class="rounded bg-gray-800 p-2 dark:bg-surface-muted">
                    <p class="text-xs leading-relaxed text-ink-muted">
                      <span
        ...
        <div class="border-t pt-4">
          ...
          <div
            ...
            class="overflow-hidden rounded-lg border border-line bg-surface-muted/50 dark:border-line-strong dark:bg-surface/40"
          >
            <div
              v-if="!createModelsListLoading && createModelsListState.items.length > 0"
              class="flex items-center justify-between gap-2 border-b border-line bg-surface-muted px-3 py-2 text-xs dark:border-line-strong dark:bg-surface"
            >
              <span class="text-ink-muted dark:text-ink-muted">
                {{
              ...
              <div class="flex items-center gap-1.5">
                ...
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-ink transition-colors hover:bg-surface-muted dark:text-ink-muted dark:hover:bg-dark-700"
            ...
            >
              <p v-if="createModelsListLoading" class="text-xs text-ink-muted dark:text-ink-muted">
              ...
              <div
                ...
                :key="item.id"
                class="flex items-center gap-2 rounded border border-line bg-white px-3 py-2 dark:border-line-strong dark:bg-surface"
              >
                <input
                ...
                <button
                  type="button"
                  :disabled="index === 0"
                  class="rounded p-1 text-ink-muted hover:bg-surface-muted hover:text-ink disabled:opacity-40 dark:hover:bg-dark-600 dark:hover:text-gray-200"
        ...
        >
          <label
            class="block mb-2 font-medium text-ink dark:text-ink-muted"
          >
            {{ t(imagePricingI18nKey(createForm.platform, "title")) }}
          </label>
          <p class="text-xs text-ink-muted dark:text-ink-muted mb-3">
            {{ t(imagePricingI18nKey(createForm.platform, "description")) }}
          </p>
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <label class="flex items-center gap-2 text-sm text-ink dark:text-ink-muted">
              <input
                v-model="createForm.allow_image_generation"
                type="checkbox"
                class="rounded border-line-strong text-blue-600 focus:ring-blue-500"
              />
          ...
          <p class="mt-3 text-xs text-ink-muted dark:text-ink-muted">
            {{ t(imagePricingI18nKey(createForm.platform, "modeHint")) }}
          </p>
          <div class="mt-2 rounded-lg bg-surface-muted p-3 text-xs text-ink dark:bg-surface dark:text-ink-muted">
          ...
          <div v-if="createForm.platform === 'gemini' && createForm.allow_image_generation" class="mt-4 border-t border-dashed border-line pt-4 dark:border-line">
            <label
              class="flex items-center gap-2 text-sm font-medium text-ink dark:text-ink-muted"
            >
              <input
          ...
          <p
            ...
            class="mt-4 border-t border-dashed border-line pt-4 text-xs text-ink-muted dark:border-line dark:text-ink-muted"
          >
        ...
        >
          ...
          <div
            class="mt-4 border-t border-dashed border-line pt-4 dark:border-line"
          ...
          >
            ...
            <div class="mt-3 space-y-3">
              ...
              >
                <div class="min-w-0 pb-1 font-mono text-xs text-ink dark:text-ink-muted">
                  {{ family.label }}
                </div>
                <label
                  ...
                  class="block"
                >
                  <span class="mb-1 block text-xs text-ink-muted dark:text-ink-muted">
                    {{ resolution.label }} ($/s)
                  </span>
                  <input
        ...
        <div v-if="isProfitControlPlatform(createForm.platform)" class="border-t pt-4">
          ...
          <p class="mb-3 mt-1.5 text-xs text-ink-muted dark:text-ink-muted">
            {{
          ...
          <div class="space-y-2">
            <label class="flex items-center gap-2 cursor-pointer">
              <input
                ...
                class="h-4 w-4 rounded border-line-strong text-primary-600 focus:ring-primary-500 dark:border-line-strong dark:bg-surface-muted"
              />
              <span class="text-sm text-ink dark:text-ink-muted">{{
        ...
        <div
          ...
          class="border-t border-line dark:border-line-strong pt-4 mt-4"
        >
          <h4 class="text-sm font-medium text-ink dark:text-ink-muted mb-3">
          ...
          <div>
            ...
            <div
              class="mt-2 rounded-lg bg-surface-muted p-3 text-xs text-ink dark:bg-surface-muted dark:text-ink-muted"
            >
              {{
        ...
        <div class="border-t border-line pt-4 mt-4 dark:border-line-strong">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="min-w-0 flex-1">
              <h4 class="text-sm font-medium text-ink dark:text-ink-muted">{{ t("admin.groups.modelPricing.title") }}</h4>
              <p class="mt-1 text-xs text-ink-muted dark:text-ink-muted">{{ t("admin.groups.modelPricing.description") }}</p>
            </div>
          ...
          <label class="mt-3 flex items-start gap-2">
            ...
            <span><span class="block text-sm text-ink dark:text-ink-muted">{{ t("admin.groups.modelPricing.longContext") }}</span><span class="block text-xs text-ink-muted">{{ t("admin.groups.modelPricing.longContextHint") }}</span></span>
          </label>
        ...
        <div
          ...
          class="border-t border-line dark:border-line-strong pt-4 mt-4"
        >
          <h4 class="text-sm font-medium text-ink dark:text-ink-muted mb-1">
        ...
        >
          ...
          >
            <div
              class="relative overflow-hidden rounded-xl border border-line bg-white shadow-sm dark:border-line-strong dark:bg-surface"
            >
              <div
                class="border-b border-line bg-surface-muted/80 px-4 py-3 dark:border-line dark:bg-surface-muted/50"
              >
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-xl border border-primary-200 bg-white shadow-sm dark:border-primary-900/50 dark:bg-surface"
            >
              <div
              ...
              <div class="p-4 bg-surface-muted/30 dark:bg-surface/30">
                <div
                  v-if="createForm.exact_model_mappings.length === 0"
                  class="flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-primary-200 bg-white px-5 py-4 text-sm text-primary-700 transition-colors hover:border-primary-300 dark:border-primary-900/40 dark:bg-surface dark:text-primary-300 dark:hover:border-primary-800"
                >
                  <span>{{
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-line bg-white p-4 shadow-sm transition-all hover:border-primary-300 hover:shadow-md dark:border-line-strong dark:bg-surface-muted dark:hover:border-primary-700"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-surface-muted focus:bg-white dark:bg-surface dark:focus:bg-dark-900"
                          />
                        </div>
                        <div
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-lg text-ink-muted transition-colors hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/20 dark:hover:text-red-400"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-line-strong bg-white py-3 text-sm font-medium text-ink-muted transition-all hover:border-primary-300 hover:bg-primary-50/50 hover:text-primary-600 dark:border-line-strong dark:bg-surface dark:text-ink-muted dark:hover:border-primary-800 dark:hover:bg-primary-900/20 dark:hover:text-primary-400"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div
          ...
          "
          class="border-t border-line dark:border-line-strong pt-4 mt-4 space-y-4"
        >
          <h4 class="text-sm font-medium text-ink dark:text-ink-muted mb-3">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              >
              <p class="text-xs text-ink-muted dark:text-ink-muted mt-0.5">
                {{
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <p
            ...
            class="text-xs text-ink-muted dark:text-ink-muted mb-3"
          >
            {{ t("admin.groups.modelRouting.disabledHint") }}
          </p>
          <p v-else class="text-xs text-ink-muted dark:text-ink-muted mb-3">
          ...
          <div v-if="createForm.model_routing_enabled" class="space-y-3">
            <div
              ...
              class="rounded-lg border border-line p-3 dark:border-line-strong"
            >
              <div class="flex items-start gap-3">
                      ...
                      <div
                        v-if="
                          ...
                          accountSearchResults[getCreateRuleSearchKey(rule)]
                            ?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-lg border bg-white shadow-lg dark:border-line-strong dark:bg-surface"
                      >
                        <button
                          ...
                          class="w-full px-3 py-2 text-left text-sm hover:bg-surface-muted dark:hover:bg-dark-700"
                          :class="{
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-ink-muted hover:text-red-500 transition-colors"
    ...
    >
      ...
      >
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            <div
              class="max-h-64 space-y-2 overflow-y-auto p-2"
            >
              <p v-if="editModelsListLoading" class="text-xs text-ink-muted dark:text-ink-muted">
                {{ t("admin.groups.modelsList.loading") }}
              </p>
              <p
        ...
        >
          ...
          <div v-if="editForm.platform === 'gemini' && editForm.allow_image_generation" class="mt-4 border-t border-dashed border-line pt-4 dark:border-line">
            <label
              class="flex items-center gap-2 text-sm font-medium text-ink dark:text-ink-muted"
            >
              <input
      ...
      <div class="space-y-4">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-line bg-white p-3 transition-shadow hover:shadow-md active:cursor-grabbing dark:border-line-strong dark:bg-surface-muted"
          >
            ...
            <div class="text-sm text-ink-muted">#{{ group.id }}</div>
          </div>
        </VueDraggable>
      </div>
    ...
    >
      <div class="grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
        <section class="min-w-0">
          ...
          <div
            class="overflow-hidden rounded-lg border border-line dark:border-line-strong"
          >
            <div
              v-if="compositeRoutesLoading"
              class="flex h-36 items-center justify-center text-sm text-ink-muted dark:text-ink-muted"
            >
              {{ t("common.loading") }}
            </div>
            <div
            ...
            <div v-else class="overflow-x-auto">
              <table class="min-w-full divide-y divide-line text-sm dark:divide-line-strong">
                <thead class="bg-surface-muted text-left text-xs font-medium uppercase tracking-wide text-ink-muted dark:bg-surface dark:text-ink-muted">
                  <tr>
                    <th class="px-3 py-2">
                ...
                <tbody class="divide-y divide-line bg-white dark:divide-line dark:bg-canvas">
                  ...
                  >
                    <td class="max-w-[15rem] px-3 py-2">
                      <div class="break-all font-medium text-ink-strong dark:text-white">
                        {{ route.public_model }}
                      </div>
                    ...
                    <td class="px-3 py-2">
                      <div class="flex items-center gap-1.5 text-ink-strong dark:text-white">
                        <PlatformIcon :platform="route.target_platform" size="xs" />
                        <span>{{ formatCompositePlatform(route.target_platform) }}</span>
                      </div>
                      <div class="mt-1 break-all text-xs text-ink-muted dark:text-ink-muted">
                        {{ route.upstream_model || route.public_model }}
                      </div>
                    </td>
                    <td class="px-3 py-2">
                      <div class="text-ink dark:text-ink-muted">
                    ...
                    <td class="px-3 py-2">
                      <div class="flex justify-end gap-1">
                        <button
                          type="button"
                          class="rounded p-1.5 text-ink-muted hover:bg-surface-muted hover:text-primary-600 dark:hover:bg-dark-700 dark:hover:text-primary-400"
                          :title="t('common.edit')"
                        ...
                        <button
                          type="button"
                          class="rounded p-1.5 text-ink-muted hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
        ...
        <section class="space-y-5">
          <form class="space-y-3" @submit.prevent="saveCompositeRoute">
            <div class="flex items-center justify-between gap-3">
              ...
              <button
                ...
                type="button"
                class="text-xs font-medium text-ink-muted hover:text-ink dark:text-ink-muted dark:hover:text-gray-200"
          ...
          <div class="border-t border-line pt-4 dark:border-line-strong">
            <h3 class="mb-3 text-sm font-semibold text-ink-strong dark:text-white">
            ...
            <div class="space-y-3">
              ...
              <div
                ...
                class="rounded-lg border border-line bg-surface-muted p-3 text-sm dark:border-line-strong dark:bg-surface"
              >
                ...
                <div
                  ...
                  class="space-y-1 text-ink dark:text-ink-muted"
                >
                  <div>
                    {{ t("admin.groups.compositeRoutes.targetPlatform") }}:
                    {{
...
const getQuotaUsageClass = (
  ...
  if (!limit || limit <= 0) {
    return "font-medium text-ink dark:text-ink-muted";
  }

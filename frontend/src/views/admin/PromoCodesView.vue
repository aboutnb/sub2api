<template>
  <AppLayout>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-muted transition-colors hover:bg-surface-muted hover:text-ink dark:hover:bg-dark-600 dark:hover:text-ink-muted"
                :title="t('common.edit')"
              >
      ...
      <form id="create-promo-form" @submit.prevent="handleCreate" class="space-y-4">
        <div>
          <label class="input-label">
            {{ t('admin.promo.code') }}
            <span class="ml-1 text-xs font-normal text-ink-muted">({{ t('admin.promo.autoGenerate') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-ink-muted">({{ t('admin.promo.zeroUnlimited') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-ink-muted">({{ t('common.optional') }})</span>
          </label>
          <input
    ...
    >
      ...
      <div v-else-if="usages.length === 0" class="py-8 text-center text-ink-muted dark:text-ink-muted">
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="usage.id"
          class="flex items-center justify-between rounded-lg border border-line p-3 dark:border-line-strong"
        >

    ...
    <div class="custom-page-layout">
      <div class="card flex-1 min-h-0 overflow-hidden">
        ...
        >
          <div class="max-w-md">
            <div
              class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-surface-muted dark:bg-surface-muted"
            >
              <Icon name="link" size="lg" class="text-ink-muted" />
            </div>
            <h3 class="text-lg font-semibold text-ink-strong dark:text-white">
              {{ t('customPage.notFoundTitle') }}
            </h3>
            <p class="mt-2 text-sm text-ink-muted dark:text-ink-muted">
...
.toc-sidebar {
  @apply flex flex-col h-full border-r border-line dark:border-line-strong bg-surface-muted dark:bg-surface;
  width: min(240px, 30%);
  min-width: 160px;
  max-width: 280px;
  overflow: hidden;
...
.toc-header {
  @apply flex items-center justify-between px-4 py-3 border-b border-line dark:border-line-strong;
}

.toc-title {
  @apply text-sm font-semibold text-ink dark:text-ink-strong;
}

.toc-close-btn {
  @apply p-1 rounded text-ink-muted hover:text-ink dark:hover:text-ink-strong hover:bg-line dark:hover:bg-dark-600 transition-colors;
}
...
.toc-item {
  ...
  @apply text-ink dark:text-ink hover:text-ink-strong dark:hover:text-white hover:bg-line dark:hover:bg-dark-600;
}
...
.toc-toggle-btn {
  ...
  @apply bg-white dark:bg-surface-muted border border-line dark:border-line-strong;
  @apply text-ink dark:text-ink hover:bg-surface-muted dark:hover:bg-dark-600;
...
.markdown-page-content h1 { @apply text-3xl font-bold mt-8 mb-4 pb-2 border-b border-line dark:border-line-strong; }
...
.markdown-page-content blockquote { @apply border-l-4 border-line-strong dark:border-line-strong pl-4 italic text-ink dark:text-ink my-4; }
...
.markdown-page-content th { @apply border border-line-strong dark:border-line-strong px-3 py-2 bg-surface-muted dark:bg-surface-muted font-semibold text-left; }
.markdown-page-content td { @apply border border-line-strong dark:border-line-strong px-3 py-2; }
.markdown-page-content code { @apply bg-surface-muted dark:bg-surface-muted px-1.5 py-0.5 rounded text-sm font-mono; }
.markdown-page-content pre { @apply bg-gray-900 dark:bg-canvas text-gray-100 p-4 rounded-lg overflow-x-auto my-4 relative; }
.markdown-page-content pre code { @apply bg-transparent p-0 text-inherit; }
.markdown-page-content hr { @apply my-6 border-line dark:border-line-strong; }

  ...
  <AppLayout>
    <div class="mx-auto max-w-lg space-y-6 py-8">
      ...
      <div v-else-if="errorMessage" class="card p-8 text-center">
        ...
        <h3 class="text-lg font-semibold text-ink-strong dark:text-white">{{ t('payment.airwallexLoadFailed') }}</h3>
        <p class="mt-2 text-sm text-ink-muted dark:text-ink-muted">{{ errorMessage }}</p>

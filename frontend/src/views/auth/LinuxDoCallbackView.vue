      ...
      <transition name="fade">
        ...
        >
          <div
            ...
            class="rounded-xl border border-line bg-surface-muted p-4 dark:border-line-strong dark:bg-surface/60"
          >
            <div class="space-y-3">
              <div class="space-y-1">
              ...
              <label
                ...
                class="flex items-start gap-3 rounded-lg border border-line bg-white p-3 text-sm dark:border-line-strong dark:bg-canvas/50"
              >
                <input v-model="adoptDisplayName" type="checkbox" class="mt-1 h-4 w-4" />
                <span class="space-y-1">
                  <span class="block font-medium text-ink-strong dark:text-white">
                    {{ t('auth.oauthFlow.useDisplayName') }}
                  </span>
                  <span class="block text-ink-muted dark:text-ink-muted">
              ...
              >
                ...
                <img
                  ...
                  class="h-10 w-10 rounded-full border border-line object-cover dark:border-line-strong"
                />
                <span class="space-y-1">
                  <span class="block font-medium text-ink-strong dark:text-white">
                    {{ t('auth.oauthFlow.useAvatar') }}
                  </span>
                  <span class="block break-all text-ink-muted dark:text-ink-muted">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
          ...
          <template v-else-if="needsChooser">
            <div class="rounded-xl border border-line bg-surface-muted p-4 dark:border-line-strong dark:bg-surface/60">
              <div class="space-y-4">
                <div class="space-y-1">
                  <p class="text-sm font-medium text-ink-strong dark:text-white">

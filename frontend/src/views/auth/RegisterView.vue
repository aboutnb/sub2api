  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div class="text-center">
        <h2 class="text-2xl font-bold text-ink-strong dark:text-white">
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="mail" size="md" class="text-ink-muted dark:text-ink-muted" />
            </div>
            <input
              id="email"
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="lock" size="md" class="text-ink-muted dark:text-ink-muted" />
            </div>
            <input
              id="password"
            ...
            <button
              ...
              class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-ink-muted transition-colors hover:text-ink dark:hover:text-ink"
            >
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-green-500' : 'text-ink-muted dark:text-ink-muted'" />
            </div>
            <input
              id="invitation_code"
            ...
            <div v-if="invitationValidating" class="absolute inset-y-0 right-0 flex items-center pr-3.5">
              <svg class="h-4 w-4 animate-spin text-ink-muted" fill="none" viewBox="0 0 24 24">
        ...
        <div v-else-if="affiliateEnabled" data-testid="affiliate-invitation-field">
          <label for="affiliate_code" class="input-label">
            {{ t('auth.invitationCodeLabel') }}
            <span class="ml-1 text-xs font-normal text-ink-muted dark:text-ink-muted">({{ t('common.optional') }})</span>
          </label>
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" class="text-ink-muted dark:text-ink-muted" />
            </div>
            <input
              id="affiliate_code"
        ...
        <div v-if="promoCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-green-500' : 'text-ink-muted dark:text-ink-muted'" />
            </div>
            <input
              id="promo_code"
      ...
      <div v-if="showOAuthLogin" class="space-y-3 pt-1">
        <div class="flex items-center gap-3">
          <div class="h-px flex-1 bg-line dark:bg-surface-muted"></div>

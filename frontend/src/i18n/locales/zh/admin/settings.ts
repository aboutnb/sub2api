export default {
    settings: {
      ...
      payment: {
        ...
        rechargeBonusTiersHint: '按充值本金匹配最高门槛，手续费不参与赠送；删除全部档位可关闭。',
        rechargeBonusThreshold: '起充金额',
        rechargeBonusPercent: '赠送比例',
        addRechargeBonusTier: '新增赠送档位',
        removeRechargeBonusTier: '删除赠送档位',
        rechargeBonusDisabled: '当前未启用充值赠送。',
        ...
        validationEasyPayCustomMethodUpstreamTypeInvalid: '易支付上游 type 只能包含小写字母、数字、下划线、短横线，且最多包含一个点号',

export default {
    ...
    users: {
      ...
      bulkLimits: {
        ...
        unlimited: '不限制',
        nonNegativeInteger: '请输入有效整数；并发可填 -1（禁止请求），RPM 不可为负数。',
        apply: '应用限制',
        applying: '应用中...',
      ...
      form: {
        ...
        selectStatus: '选择状态',
        rpmLimit: '每分钟请求数 (RPM)',
        concurrencyPlaceholder: '-1 禁止请求，0 不限制',
        concurrencyHint: '该用户并发：-1 = 禁止请求，0 = 不限制，正数 = 最大并发数',
      ...
      failedToAdjust: '调整失败',
      emailRequired: '请输入邮箱',
      concurrencyNonNegative: '并发数必须为 -1 或更大；-1 表示禁止请求，0 表示不限制',
    ...
    groups: {
      ...
      form: {
        ...
        priorityLabel: '优先级',
        priorityHint: '1 为最高优先级，数值越小越优先，用于账号调度',
        statusLabel: '状态'
      },
      exclusiveObj: {
        yes: '是',

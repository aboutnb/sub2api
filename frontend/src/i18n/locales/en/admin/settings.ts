export default {
    settings: {
      ...
      payment: {
        ...
        usdtMinAmount: 'USDT Minimum Amount',
        ...
        rechargeBonusTiersHint: 'The highest threshold reached by the recharge principal applies. Fees are not bonused; remove all tiers to disable.',
        rechargeBonusThreshold: 'Minimum Amount',
        rechargeBonusPercent: 'Bonus Percentage',
        addRechargeBonusTier: 'Add bonus tier',
        removeRechargeBonusTier: 'Remove bonus tier',
        rechargeBonusDisabled: 'Recharge bonuses are disabled.',
        ...
        validationEasyPayCustomMethodUpstreamTypeInvalid: 'EasyPay upstream types may only contain lowercase letters, digits, underscores, hyphens, and at most one period',

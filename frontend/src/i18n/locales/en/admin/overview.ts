export default {
    ...
    users: {
      ...
      bulkLimits: {
        ...
        unlimited: 'Unlimited',
        nonNegativeInteger: 'Enter a valid whole number; concurrency accepts -1 (deny), while RPM cannot be negative.',
        apply: 'Apply limits',
        applying: 'Applying...',
      ...
      form: {
        ...
        concurrencyPlaceholder: '-1 deny, 0 unlimited',
        concurrencyHint: 'User concurrency: -1 = deny requests, 0 = unlimited, positive values set the maximum.',
      ...
      concurrencyNonNegative: 'Concurrency must be -1 or greater; -1 denies requests and 0 is unlimited',
    ...
    groups: {
      ...
      form: {
        ...
        priorityHint: 'Priority 1 is highest; lower values are preferred for account scheduling',
        statusLabel: 'Status'
      },
      exclusiveObj: {
        yes: 'Yes',

  ...
  admin: {
    ...
    proxies: {
      ...
      projectMihomo: {
        title: '项目 mihomo',
        manage: '配置',
        subscriptionUrl: '项目 mihomo 订阅地址',
        subscriptionUrls: '订阅链接',
        subscriptionUrlsHint: '支持多条订阅链接，一行一条，mihomo 会统一聚合使用',
        targetHost: '项目代理主机',
        controllerUrl: '控制器地址',
        startPort: '起始端口',
        listenerCount: '端口数量',
        ...
        save: '保存配置',
        sync: '同步到代理',
        saved: '项目 mihomo 配置已保存',
        saveFailed: '项目 mihomo 配置保存失败',
        syncDone: '项目 mihomo 同步完成，新增 {created} 个，复用 {reused} 个，分配 {assigned} 个节点',
        syncFailed: '项目 mihomo 同步失败',

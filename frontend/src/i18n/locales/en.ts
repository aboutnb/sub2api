export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      accountNotes: 'Notes',
      projectMihomo: {
        title: 'Project mihomo',
        manage: 'Configure',
        subscriptionUrl: 'Project mihomo subscription URL',
        subscriptionUrls: 'Subscription URLs',
        subscriptionUrlsHint: 'Supports multiple subscription URLs, one per line. Mihomo will aggregate them together.',
        ...
        saved: 'Project mihomo configuration saved',
        saveFailed: 'Failed to save project mihomo configuration',
        syncDone: 'Project mihomo synced: created {created}, reused {reused}, assigned {assigned} nodes',
        syncFailed: 'Failed to sync project mihomo',

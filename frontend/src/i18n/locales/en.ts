  ...
  admin: {
    ...
    proxies: {
      ...
      projectMihomo: {
        ...
        subscriptionUrlsHint: 'Supports multiple subscription URLs added one by one. Mihomo will aggregate them together. Enter only a name to create a static YAML source.',

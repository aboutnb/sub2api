export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportWarning: 'Import will create new accounts/proxies. Select groups below to bind imported accounts immediately.',
      dataImportFile: 'Data file',
      dataImportGroupsLoading: 'Loading groups...',
      dataImportGroupsLoadFailed: 'Failed to load groups',
      dataImportUseProjectMihomo: 'Assign imported accounts with the Project Mihomo proxy pool',
      dataImportUseProjectMihomoHint:
        'When enabled, imported accounts are distributed across configured Mihomo listener ports based on current usage.',
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      proxyModeDirect: 'Choose a single proxy',
      proxyModeDirectHint: 'Bind this account to one specific configured proxy.',
      proxyModeProjectMihomo: 'Project Mihomo proxy pool',
      proxyModeProjectMihomoHint: 'Automatically assign the best route from configured Mihomo listener ports.',
      proxyModeProjectMihomoSummary:
        'After saving, the system will choose a less-loaded Mihomo listener with better recent quality/latency. Batch creation is automatically balanced across the pool.',
      concurrency: 'Concurrency',
      ...
      batchTest: {
        ...
        testModel: 'Test Model',
        defaultModel: 'Default test model (per account)',
        customModel: 'Specify one model',
        customModelPlaceholder: 'e.g. claude-sonnet-4-5 or gpt-5.4',
        concurrency: 'Test Concurrency',
        concurrencyHint: 'Number of accounts tested at the same time, maximum 50.',
        resultFilter: 'Result Filter',
        filters: {
          all: 'All ({count})',
          success: 'Success ({count})',
          failed: 'Failed ({count})',
          unauthorized: '401 ({count})',
          rateLimited: '429 ({count})',
          otherFailed: 'Other Failed ({count})'
        },
        columns: {
          account: 'Account',
          platform: 'Platform',
        ...
        stopping: 'Stopping...',
        loadingAccounts: 'Loading accounts...',
        noAccounts: 'No accounts available for testing',
        loadFailed: 'Failed to load accounts for batch test',
        empty: 'No accounts available',
        noFilteredResults: 'No results match the current filter',
        noResult: '-',
        runningResult: 'Testing...',
        successResult: 'Test completed successfully',
        stoppedResult: 'Stopped',
        noResponseBody: 'No response body',
        streamEnded: 'Test stream ended without completion',
        streamEndedWithModel: 'Test stream ended without completion. Model: {model}'
      },
      // Stats Modal
    ...
    proxies: {
      ...
      accountNotes: 'Notes',
      projectMihomo: {
        title: 'Multi-Port Proxy',
        manage: 'Configure',
        subscriptionUrl: 'Proxy node subscription URL',
        subscriptionUrls: 'Subscription URLs',
        subscriptionUrlsHint: 'Supports multiple subscription URLs. URL subscriptions are downloaded directly by the backend into local provider files so subscription refreshes do not use proxy IPs. Enter only a name to create a static YAML source.',
        proxySources: 'Proxy sources',
        proxySourceName: 'Name',
        ...
        providerKey: 'Stable source ID',
        deleteSource: 'Delete this proxy source',
        fetchMode: 'Fetch mode',
        fetchModeMihomo: 'Backend direct fetch',
        fetchModeMihomoHint: 'Legacy-compatible mode: saving converts it to backend direct fetch so subscription refreshes do not use proxy IPs.',
        fetchModeBackend: 'Backend direct fetch',
        fetchModeBackendHint: 'Sub2API downloads directly from the subscription server and stores a static provider file without using the current proxy node. If the subscription URL expires or refresh fails, the previous file stays usable; removing the source cleans up its file.',
        fetchModeStatic: 'Static YAML',
        fetchModeStaticHint: 'Store pasted Clash/Mihomo YAML as a local provider file without requesting the subscription URL; removing the source cleans up its file.',
        staticYaml: 'YAML content',
        staticYamlPlaceholder: 'Paste Clash/Mihomo YAML content that contains proxies',
        uploadYaml: 'Upload YAML',
        yamlFileLoaded: 'Loaded YAML file: {name}',
        yamlFileEmpty: 'YAML file is empty',
        yamlFileTooLarge: 'YAML file must be 16MB or smaller',
        yamlFileLoadFailed: 'Failed to read YAML file',
        ...
        autoRouteHint: 'When enabled, each port uses latency-based routing within its selected scope. Exclude keywords still apply.',
        autoRouteTolerance: 'Tolerance (ms)',
        autoRouteInterval: 'Check interval (s)',
        autoRouteAnywhere: 'Use all available nodes after filters',
        autoRouteRegionMeta: '{count} nodes',
        nodeExclude: 'Exclude nodes',
        nodeExcludeHint: 'When enabled, matching nodes such as Hong Kong or Taiwan are hidden and skipped. One keyword per line.',
        nodeExcludePlaceholder: 'Hong Kong\nHK\nTaiwan\nTW',
        summary: 'Local multi-port proxy assignment',
        summaryHint: '{count} nodes',
        listenerSummaryHint: '{count} listeners',
        save: 'Save config',
        sync: 'Sync to proxies',
        saved: 'Multi-port proxy configuration saved',
        saveFailed: 'Failed to save multi-port proxy configuration',
        proxyInUseConfirm: 'The removed Mihomo proxy is used by {count} account(s).\nProxy: {proxies}\nAccount: {accounts}\nContinue to clear those account proxy selections and delete it?',
        syncDone: 'Multi-port proxy synced: created {created}, reused {reused}, assigned {assigned} nodes',
        syncFailed: 'Failed to sync multi-port proxy',
        testNodeLatency: 'Check latency',
        testingNodeLatency: 'Checking latency...',
        testLatencyDone: 'Node latency check finished: {count} nodes',
        testLatencyDoneWithSelected: 'Node latency check finished: {count} source nodes; {selected} selected listener nodes also checked',
        testLatencyDoneWithSelectedPartial: 'Node latency check finished: {count} source nodes; checked {selected} selected listener nodes, {failed} failed',
        testLatencyDoneSelectedFailed: 'Node latency check finished: {count} source nodes, but selected listener nodes could not be checked',
        testLatencyFailed: 'Failed to check node latency',
        testSingleNodeLatency: 'Check selected node',
        testingSingleNodeLatency: 'Checking...',
        testSingleNodeLatencyDone: 'Latency check finished for {name}',
        testSingleNodeLatencyFailed: 'Failed to check selected node latency',
        protocolLabel: 'Protocol {protocol}',
        configPath: 'Config {path}',
        listenerRegion: 'Port {port} region',
        listenerNode: 'Port {port} node',
        listenerRoute: 'Port {port} route',
        regionAuto: 'Auto',
        regionPlaceholder: 'Choose from current subscription node regions',
        nodePlaceholder: 'Choose from current subscription nodes',
        routePlaceholder: 'Choose auto route scope or exact node',
        legacyRegion: 'Saved region',
        regionUnknown: 'Unknown region',
        latencyFailedShort: 'Failed',
        latencyUnknown: 'Latency not checked',
        latencyFailed: 'Latency check failed',
